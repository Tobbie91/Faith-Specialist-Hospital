...
<div className="px-[4.1%] pt-10 pb-[13px] lg:pt-0 lg:pb-[45px] fellix max-w-screen-xxl xxl:mx-auto ">
  <div className="">
    <div className="flex flex-col text-left mt-[-2em] ">
      ...
      <p className="text-[16px] font-normal text-[#444A5B] leading-{25px}
">
        Experience unparalleled expertise,<br/> compassionate care, and
        advanced <br/> Orthopedic treatments at Faith Specialist <br/> Hospital
      </p>
        ...
        <div className="flex flex-col">
          ...
          <div className="text-[12px] 390:text-[14px] lg:text-[14px] xl:text-[18px] mt-[2em] ">
            ...
            <p className="text-[14px]  text-[#444A5B] font-normal leading-[25px] mb-[2em]">
              Our hospital is home to a team of board-certified orthopedic
              surgeons, general practitioners, internal medicine doctors,
              pediatricians, and more. With extensive training and
              experience, ourspecialists are leaders in their fields,
        ...
        <div className="flex flex-col ">
          ...
          <div className="text-[12px] 390:text-[14px] lg:text-[14px] xl:text-[18px]  mt-[2em]">
            ...
            <p className="text-[14px] xl:text-[18px] xxl:text-[19px] 1380:text-[18px] text-[#444A5B] font-normal mb-[1em]">
              We understand that every patient is unique. That’s why we
              create customized treatment plans tailored to your specific
              health needs and goals. Our personalized approach ensures
